...
/**
*Function for temperature conversion between the celsius, fahrenheit and kelvin temperature scales
*@author Chigozie Davis
*refactored this block of code because the switch loops were too deeply nested
**/
void temp(){
